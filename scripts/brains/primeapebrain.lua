...
local function IsPlayerFriendOfPrimeapes(inst)
   return GetPlayer().components.leader:CountFollowers("primeape") > 0 or GetPlayer():HasTag("monkey") or GetPlayer():HasTag("gorillaz")
end
...
local function IsPlayerFriendOfMe(inst)
   return FriendsWithPlayer(inst) or GetPlayer():HasTag("monkey") or GetPlayer():HasTag("gorillaz")
end
